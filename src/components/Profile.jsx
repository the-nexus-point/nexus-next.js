...
//         <div className="w-full flex min-[320px]:max-lg:flex-col border-b border-gray-700 py-10 space-y-5">
//           <div className="w-1/2 min-[320px]:max-lg:w-full flex flex-col justify-center items-center space-y-2">

  ...
  return (
      <div className="p-2 flex flex-col space-y-1 bg-[#141718] ">
        ...
        <Post
          ...
          content="TBH I think Development >>>> DSA."
        />
        <Post
          username="harsh.2125csai1044"
          content="Unpopular opinion Next.js is not the future of react.js its present now, I mean why do you people still use react.
          It give us Full-stack Development environment without any headache of differnt front-end and back-end server."
        />
        <Post
          username="abhishek.2125csai1044"
